...
let footer (ctx: SiteContents) =
    ...
    [ div [ Custom(
                "style",
                "left: -1000px; overflow: scroll; position: absolute; top: -1000px; border: none; box-sizing: content-box; height: 200px; margin: 0px; padding: 0px; width: 200px;"
            ) ] [
          div [ Custom(
                    "style",
                    "border: none; box-sizing: content-box; height: 200px; margin: 0px; padding: 0px; width: 200px;"
                ) ] []
      ]
      ...
      link [ Rel "stylesheet"
             Href(rootUrl + "/static/mermaid/mermaid.css") ]
